...
<div class="container mt-7">
  ...
  <form action="customer_db.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row dropdowncolmns">
          ...
          <div class="col-md-6">
            <div class="input-field-container">
              ...
              <select class="styled-input" id="relationship" name="relationship" required>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          <label class="input-label">Care Requirements</label>
          <select class="styled-input" name="care_requirements" required>
            <option value="" disabled selected>Select care requirements</option>
